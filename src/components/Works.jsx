    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          The following projects highlight my skills and experience as a freelance developer. Each project includes a short description along with links to the live demos. These real-world examples demonstrate my ability to deliver practical solutions, adapt to various technologies, and manage client requirements efficiently </p>
      </div>
